                ...
                <Row gutter={[24, 24]}>
                    ...
                    <Col xs={24} lg={14}>
                        ...
                        <Card className={styles.detailCard} style={{ marginTop: '16px' }}>
                            <Title level={5}>Sản phẩm đã đặt ({order.items?.length || 0} sản phẩm)</Title>
                                ...
                                {order.items?.map(item => (
                                    <div key={item.id} className={styles.modalItem}>
                                        ...
                                        <div className={styles.modalItemInfo}>
                                            <Text strong className={styles.productName}>{item.productName}</Text>
                                            <div className={styles.productDetails}>
                                                <Text type="secondary">Đơn giá: {CurrencyHelper.formatVND(item.price)} • Số lượng: x{item.quantity}</Text>
